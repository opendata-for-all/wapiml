	...
	public static ResourceSet getUMResourceSet() {
		if (umlResourceSet == null) {
			...
			if (standalone) {
				...
				umlResourceSet.getURIConverter().getURIMap().put(URI.createURI("pathmap://OPENAPI_PROFILES/"),
						openAPIBaseUri.appendSegment(""));
				UMLPlugin.getEPackageNsURIToProfileLocationMap().put(OpenAPIProfilePackage.eNS_URI,
						URI.createURI("pathmap://OPENAPI_PROFILES/openapi.profile.uml")
								.appendFragment("_8zK3wHyGEemaV87q0fd26g"));
