...
public class ConvertToJson extends AbstractHandler {
	...
	public static final String ID = "edu.uoc.som.openapitouml.ui.popup.handlers.ConvertToJson";
			...
			Job job = new Job(ID) {
				...
				protected IStatus run(IProgressMonitor monitor) {
					...
					try {
						...
						monitor.beginTask("Generationg the Json definition", IProgressMonitor.UNKNOWN);
